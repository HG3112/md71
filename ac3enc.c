/*
This file has been modified by HellGauss from FFmpeg source code
...
static void count_frame_bits_fixed(AC3EncodeContext *s)
{
    ...
    if (s->eac3) {
        ...
        frame_bits += 35; //compre
		
		//MODIFIED{
		frame_bits+=25; //8 compr + 1 chanmape + 16 chanmap
		//}
        ...
        frame_bits++;
        /* audio frame header */
        if (s->num_blocks == 6) //expstre, ahte
            frame_bits += 2;
        frame_bits += 10; // snroffststr -->spxattene
        /* exponent strategy */
		...
		//MODIFIED{  //convexpstre , convexpstr
